...
{
    [ApiController]
    [Route("api/rich-text-editor")]
    public class RichTextEditorContronller : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<RichTextEditorContronller> _logger;
        public RichTextEditorContronller(IConfiguration configuration, ILogger<RichTextEditorContronller> logger)
        {
